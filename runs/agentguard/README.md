...
2. **The status quo fails at a measurable, quantified rate**: 88% of organizations report a confirmed or suspected AI-agent security incident in the past year (`research/sources.md` S150, Gravitee, vendor-sourced); separately, orgs with over-privileged AI report a 76% incident rate vs. 17% for least-privilege deployments, a 4.5x gap (S154, Teleport, vendor-sourced) — both vendor-commissioned, read as convergent market signal rather than audited ground truth.
